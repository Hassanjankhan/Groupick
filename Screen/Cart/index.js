...
const Progressbar = ({ cart, user, nav, type }) => {
    ...
    const postOrderDetail = () => {
        ...
        try {
            API({
                ...
                data: {
                    ...
                    country: "india",
                    pincode: addressData ?.pinCode,
                    "address_name": "attibele"
                }
            })
                .then(res => console.log(res))
                .catch(err => console.log("cart/index/postOrderDetail/catch======>", err.response.data))
        } catch (error) {
        ...
        // console.log(token)
        // try {
        //     fetch('https://api.groupick.in/api/v1/orders/initiate/', {
        //         method: 'POST',
        //         headers: {
    ...
    return (
        <View style={styles.progressbar}>
            ...
            >
                ...
                <ProgressStep label="Summary" total={TOTALPRICE} onSubmit={handlePayments}>
                    <ScrollView nestedScrollEnabled={true}>
                        <View style={styles.cart_section}>
                            {/* No of item & delete btn */}
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 10 }}>
